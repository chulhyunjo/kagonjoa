...
- 카카오Oauth를 활용한 로그인 기능 구현

<img src="https://user-images.githubusercontent.com/108445259/236654862-35e181f0-62e4-4204-99cb-ba779a36e2b0.gif" width="600" height="280"/>

<br/>
2. 위치 인증

- 현재 위치 반경 50m의 모든 카페 리스트 출력(거리순)
- 본인이 위치한 카페를 선택해서 인증
- 추후 영수증 인증을 통한 2차 인증 구현 계획

<img src="https://user-images.githubusercontent.com/108445259/236654924-6f2dc141-40e6-455c-b388-ae00c720b6cc.gif" width="600" height="280"/>

<br/>
3. 혼잡도 설문 조사

- 현재 카페에 대한 혼잡도 설문 제출
- 제출시에 사용가능한 재화(커피콩) 제공

<img src="https://user-images.githubusercontent.com/108445259/236654968-1ed2d2a0-808e-4652-8c8a-10355eec08d8.gif" width="600" height="280"/>

<br/>
4. 글/댓글/대댓글 작성

- 현재 위치 반경 200m의 사용자들과 소통이 가능하도록 피드기능 구현
- 현재 위치 반경 200m의 게시글들만 출력
- 카페에서 공부하는 사람들을 타겟으로 하여 200m로 선정

<img src="https://user-images.githubusercontent.com/108445259/236655059-8a3e59fa-116f-4d7c-b3da-bd42c88f498a.gif" width="600" height="280"/>

<br/>
5. 혼잡도 지도

- 실시간 혼잡도를 확인 가능하도록하는 지도
- 현재 시간 기준 3시간 동안의 설문들을 가중치를 줘 나타냄
- 빨간색-> 혼잡, 노랑색-> 보통, 초록색-> 여유
- 클릭해서 상세 정보 확인 가능
- 현재 위치 뿐만 아닌 다른 위치 카페 및 게시글 확인 가능

<img src="https://user-images.githubusercontent.com/108445259/236655153-e35aa541-a7e2-48fc-94bd-d96c02bcf3d8.gif" width="600" height="280"/>

<br/>
6. 오늘의 카페

- 오늘 이후의 ToDo 리스트 작성하여 카페에서 공부할 리스트 기록 가능
- 재화 교환 가능
- 재화를 통해 오늘의 운세 뽑기 가능(다시 뽑기 기능 구현)

<img src="https://user-images.githubusercontent.com/108445259/236655242-29938729-b276-4e36-bd48-90d6396c26df.gif" width="600" height="280"/>

<br/>
7. 마이페이지

- 현재까지의 공부 기록을 확인할 수 있다.
- 공부한 기록을 다른 사람들과 공유가 가능하다.
- 현재까지 방문한 카페(경험치)를 확인할 수 있다.
- 내가 작성한 댓글 및 게시글 확인 가능하다.

<img src="https://user-images.githubusercontent.com/108445259/236655630-d369e64f-0fb4-474f-89e7-02495440e3e5.gif" width="600" height="280"/>
